...
with openapi_client.ApiClient() as api_client:
    ...
    api_instance = openapi_client.EventSourceServiceApi(api_client)
    namespace = 'namespace_example' # str | 
body = openapi_client.EventsourceCreateEventSourceRequest() # EventsourceCreateEventSourceRequest | 
...
with openapi_client.ApiClient() as api_client:
    ...
    namespace = 'namespace_example' # str | 
name = 'name_example' # str | 
body = openapi_client.EventsourceUpdateEventSourceRequest() # EventsourceUpdateEventSourceRequest | 
