...
class IoArgoprojEventsV1alpha1TriggerTemplate(object):
    ...
    def __init__(self, argo_workflow=None, aws_lambda=None, conditions=None, custom=None, http=None, k8s=None, kafka=None, log=None, name=None, nats=None, open_whisk=None, slack=None, switch=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def switch(self):
        """Gets the switch of this IoArgoprojEventsV1alpha1TriggerTemplate.  # noqa: E501


        :return: The switch of this IoArgoprojEventsV1alpha1TriggerTemplate.  # noqa: E501
        :rtype: IoArgoprojEventsV1alpha1TriggerSwitch
        """
        return self._switch

    @switch.setter
    def switch(self, switch):
        """Sets the switch of this IoArgoprojEventsV1alpha1TriggerTemplate.


        :param switch: The switch of this IoArgoprojEventsV1alpha1TriggerTemplate.  # noqa: E501
        :type: IoArgoprojEventsV1alpha1TriggerSwitch
        """
