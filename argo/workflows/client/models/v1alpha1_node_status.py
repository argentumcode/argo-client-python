...
class V1alpha1NodeStatus(object):
    ...
    def __init__(self, boundary_id=None, children=None, daemoned=None, display_name=None, estimated_duration=None, finished_at=None, host_node_name=None, id=None, inputs=None, memoization_status=None, message=None, name=None, outbound_nodes=None, outputs=None, phase=None, pod_ip=None, progress=None, resources_duration=None, started_at=None, synchronization_status=None, template_name=None, template_ref=None, template_scope=None, type=None, local_vars_configuration=None):  # noqa: E501
