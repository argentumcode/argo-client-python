...
class EventServiceApi(object):
    ...
    def list_workflow_event_bindings(self, namespace, **kwargs):  # noqa: E501
        ...
        :return: V1alpha1WorkflowEventBindingList
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        return self.list_workflow_event_bindings_with_http_info(namespace, **kwargs)  # noqa: E501

    def list_workflow_event_bindings_with_http_info(self, namespace, **kwargs):  # noqa: E501
        """list_workflow_event_bindings  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_workflow_event_bindings_with_http_info(namespace, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(V1alpha1WorkflowEventBindingList, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method list_workflow_event_bindings" % key
                )
        ...
        if self.api_client.client_side_validation and ('namespace' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `namespace` when calling `list_workflow_event_bindings`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='V1alpha1WorkflowEventBindingList',  # noqa: E501
